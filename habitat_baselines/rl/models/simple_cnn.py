...
class SimpleDepthCNN(SimpleCNN):
    r""" SimpleCNN where the only allowed input is a depth observation
...
class SimpleRGBCNN(SimpleCNN):
    r""" SimpleCNN where the only allowed input is an RGB observation
    regardless of what other observation modalities are provided.
    """
