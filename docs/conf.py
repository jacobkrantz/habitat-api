...
habitat.core.__all__ = ['env', 'embodied_task', 'dataset', 'simulator', 'registry', 'vector_env']
# yacs.config isn't ours, so don't document it
habitat.config.__all__.remove("Config")

# TODO make those inspectable somehow
habitat.core.env.Env.observation_space = {}
habitat.core.env.Env.action_space = {}
habitat.core.embodied_task.EmbodiedTask.measurements = {}
habitat.core.embodied_task.EmbodiedTask.sensor_suite = {}
...
M_SPHINX_INVENTORIES = [
    (os.path.join(os.path.realpath(os.path.dirname(__file__)), '../../habitat-sim/docs/python.inv'), 'https://docs.python.org/3/', [], ['m-doc-external']),
    (os.path.join(os.path.realpath(os.path.dirname(__file__)), '../../habitat-sim/docs/numpy.inv'), 'https://docs.scipy.org/doc/numpy/', [], ['m-doc-external']),
    (os.path.join(os.path.realpath(os.path.dirname(__file__)), '../../habitat-sim/build/docs/habitat-sim/objects.inv'), '../habitat-sim/', [], ['m-doc-external']),
]
